...
class FinalHarness:
    ...
    def decide_control(self, task: dict[str, Any]) -> str:
        ...
        if has_rb:
            ...
            if dac == "authority_incomplete" or sbu == "dispatch_blocked_until_binding":
                return "ask"
            if sbu in ("redacted_external_boundary", "local_update_boundary"):
                return "amend"
        if rm.get("session_share_policy") == "normal":
            return "proceed"
        return "amend"
    ...
    def infer_target(self, task: dict[str, Any], control: str) -> str:
        ...
        if control == "ask":
            ...
            # a neutral (record-decided) ask routes to the resolved channel.
        ...
        if control == "hold":
            ...
            # a neutral (record-decided) hold routes to the resolved channel.
