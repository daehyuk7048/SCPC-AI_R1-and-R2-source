...
class FinalHarness:
    ...
    def _profile_channel(self, blob, prof):
        ...
        # reuse a prior success / apply a stored enterprise policy / a verified internal
        # approval-channel exception -> the profile's approval channel
    ...
    def _mode_for(self, task, control, target, focal_id=None):
        ...
        if control == "ask":
            ...
            sbu_val = _first_rec(task, "share_boundary_update") or ""
